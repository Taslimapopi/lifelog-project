...
const AddLessonForm = () => {
  ...
  if (!description?.trim()) {
    return alert("Write your lesson description first.");
  }

  try {
    setIsGenerating(true);

    const { data } = await axiosSecure.post("/generate-title", {
      lesson: description,
    });
      ...
      <div className="w-full max-w-5xl bg-base-100 rounded-3xl shadow-xl border border-base-300 overflow-hidden">
        <div className="bg-primary p-6 text-black">
          ...
          <p className="opacity-80">
            Share your wisdom and experience with the world.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="form-control h-full">
                ...
                <div
                  className={`relative group h-full min-h-[300px] border-2 border-dashed rounded-2xl flex flex-col items-center justify-center transition-all ${preview ? "border-primary" : "border-base-300 hover:border-primary bg-base-200/50"}`}
                >
                  {preview ? (
